...
<body>
    ...
    <div align="right" class="logout-mobile">
        <!--<button class="logout-mobile" onclick="location.href='login.html'">Log out</button>-->
        <img src="/User/images/icons/logout3.png" alt="" onclick="location.href='/MedStudy-Space-System/index.php'">
        <span>Log out</span>
    </div>
    <div class="headerIntro">
        ...
        <div class="introImage">
            <img src="..\images\icons\studyRoom.jpg" alt="">
        </div>
    </div>
    ...
    <div class="studyRooms" id="studyRoom">
        ...
        <div class="room">
            <div class="roomImage">
                <img src="..\images\icons\studyRoom2.jpg" alt="">
            </div>
            <div class="roomInfo">
                <h3>Study Room 1</h3>
                <span>Available</span>
    ...
    <div class="roomOverlay" id="roomOverlay">
        <div class="roomBox">
            <img src="..\images\icons\left-arrow.png" id="backArrow" alt="" onclick="closeRoomOverlay()" id="backArrow">
            <div class="roomBoxContainer">
                <div class="leftRoom">
                    <img class="ga" src="..\images\icons\studyRoom2.jpg" alt="">
                    <h1>Study Room 1</h1>
                    <span>Available</span>
                    <div class="roomBoxDescription">
                        ...
                        <div class="leftRoomBoxDesc">
                            <div class="additionalInfo">
                                <img src="..\images\icons\crowd-of-users.png" alt="">
                                <span>5 Students</span>
                            </div>
                            <div class="additionalInfo">
                                <img src="..\images\icons\swivel-chair.png" alt="">
                                <span>5 Chairs</span>
                            </div>
                            <div class="additionalInfo">
                                <img src="..\images\icons\table.png" alt="">
                                <span>1 Table</span>
                            </div>
                        </div>
                        <div class="rightRoomBoxDesc">
                            <img src="..\images\icons\time-left.png" alt="">
                            <p>2 hours</p>
                        </div>
                    </div>
                </div>
                <div class="rightRoom">
                    ...
                    <div class="legendForCalendarRoom">
                        <div class="legendRoom">
                            <img src="..\images\icons\legendOccupied.png" alt="">
                            <span>Vacant</span>
                        </div>
                        <div class="legendRoom">
                            <img src="..\images\icons\legendUnnoccupied.png" alt="">
    ...
    <div class="bookOverlay" id="bookOverlay">
        <div class="bookBox">
            <img src="..\images\icons\left-arrow.png" alt="" onclick="closeBookOverlay()">
    ...
    <div class="bookConfirmationOverlay" id="bookConfirmationOverlay">
        <div class="bookConfirmationBox">
            <p>
                Do you want to book Study Room 1?
            </p>
            <div>
        ...
        <div class="bookConfirmedBox">
            <div class="topConfirmation">
                ...
                <div class="topRightConfirmation">
                    <h2>Booked</h2>
                    <p>Room QR Code</p>
                    <img src="..\images\icons\qr-code_Black.png" alt="">
                    <br>
                    <span>
    ...
    <div class="footer">
        <div class="topFooter">
            <div class="medStudyLogo">
                <img class="mage" src="..\images\logos\whiteVer2.png" alt="">
